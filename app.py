...
with col2:
    competency_text = ""
    author = None
    publications_texts = []  # untuk judul publikasi
        ...
        try:
            ...
            for i, course in enumerate(courses):
                ...
                if score > 0:  # tampilkan hanya > 0
                    ...
                    results.append({"Mata Kuliah": course, "Kesesuaian (%)": round(score*100), 
            ...
            if not df_results.empty:
                table_data = [["Mata Kuliah", "Kesesuaian (%)", "Publikasi Relevan"]] + df_results.values.tolist()
